...
var _SoundCloudPlayer = __webpack_require__(6);
...
$(document).ready(function () {
  ...
  var $downloadButton = $dialog.find('.btn-download');
  ...
  if ($('body').hasClass('mobile') === false) {
    ...
    var $profileHeaderContent = $('.profile-header .profile-header-content');
    var $videoContainer = $('.profile-header .video-container');
    var $youtubeVideo = $('.youtube-video');

    setTimeout(function () {
      $profileHeaderTitle.addClass('small');
      $profileHeaderContent.find('.image-container, .title-container').on('click', function () {
    ...
    if ($youtubeVideo.length) {
      new _YouTubePlayer2.default($youtubeVideo);
    }
  }
});
...
var YouTubePlayer = function () {
  _createClass(YouTubePlayer, [{
      ...
      this.player = new YT.Player('youtube-video', {
        ...
        events: {
          'onReady': function onReady() {
            _this.$videoPortraitButtons.fadeIn();
          },
    ...
    key: 'pauseAndHide',
    value: function pauseAndHide() {
      this.player.pauseVideo();
      this.$youtubeVideo.fadeOut();
    }
  }, {
    key: 'showAndPlay',
    value: function showAndPlay() {
      this.$youtubeVideo.fadeIn();
      this.player.playVideo();
    }
  }, {
    key: '$videoPortraitButtons',
    get: function get() {
  ...
  function YouTubePlayer($youtubeVideo) {
